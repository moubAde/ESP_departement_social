...
function supprimerIntervention(idetu,intervention){
  // alert("etu="+idetu+"intervention "+intervention);
  
  if (confirm("Voulez-vous vraiment supprimer cet élément:")) {
       document.location.href="modifierIntervention.php?var="+idetu+"&var1="+intervention; 
  }
  else{
